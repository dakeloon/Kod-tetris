...
//добавляет в массив местоположение тетрамино, то есть если тетрамино палочка ебанная и она ложится на координаты [0,0] [0,1] [0,2] [0,3] то эта как раз заполнит массив
	void AddGrid()
	{
